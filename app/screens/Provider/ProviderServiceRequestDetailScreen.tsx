...
const ProviderServiceRequestDetailScreen = () => {
  ...
  const loadServiceRequest = async (requestId: string) => {
    ...
    try {
      ...
      // Check multiple paths for listing price:
      // - request.listing?.price: when listing is directly attached
      // - request.lifecycle?.order?.listingId?.price: when populated via findById
  ...
  // Get listing from either direct attachment or lifecycle.order.listingId path
          ...
          <View style={styles.formSection}>
            ...
            <View style={styles.formCard}>
              <Text style={styles.formLabel}>
                Quote Price * {listing?.unitOfMeasure ?
                  `(${formatUnitOfMeasure(listing.unitOfMeasure)})` : ''}
              </Text>
              <View style={styles.priceInputContainer}>
                ...
                <TextInput
                  ...
                  autoFocus={!listing?.price}
                />
              </View>
              {listing?.price && parseFloat(quotePrice) !== listing.price && (
                <Text style={styles.priceHint}>
                  Your listing price: ₹{listing.price}
                </Text>
              )}
            </View>
          </View>
